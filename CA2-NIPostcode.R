...
write.csv(NI_Postcode_Data, "C:\\Users\\Shubhanshu Sharma\\Documents\\CA2-NI-Postcode-and-Crime-Data\\Limavady.csv")

# To write dataset into the CSV

write.csv(NI_Postcode_Data, "C:\\Users\\Shubhanshu Sharma\\Documents\\CA2-NI-Postcode-and-Crime-Data\\CleanNIPostcodedata.csv")
...
write.csv(AllNICrimeData, "C:\\Users\\Shubhanshu Sharma\\Documents\\CA2-NI-Postcode-and-Crime-Data\\AllNICrimeData.csv", )

# To show the number of rows in AllNICrimeData

AllNICrimeData = read.csv("C:\\Users\\Shubhanshu Sharma\\Documents\\CA2-NI-Postcode-and-Crime-Data\\AllNICrimeData.csv", header = TRUE )
...
cleanNIPostcode <- read.csv("C:\\Users\\Shubhanshu Sharma\\Documents\\CA2-NI-Postcode-and-Crime-Data\\CleanNIPostcodedata.csv")
cleanNIPostcode
...
write.csv(random_crime_sample, "C:\\Users\\Shubhanshu Sharma\\Documents\\CA2-NI-Postcode-and-Crime-Data\\random_crime_sample.csv")
